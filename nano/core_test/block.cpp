...
TEST (block_builder, from)
{
	...
	auto block = builder
				 .state ()
				 .account_address ("brl_15nhh1kzw3x8ohez6s75wy3jr6dqgq65oaede1fzk5hqxk4j8ehz7iqtb3to")
				 ...
				 .representative_address ("brl_1stofnrxuz3cai7ze75o174bpm7scwj9jn3nxsn8ntzg784jf1gzn1jjdkou")
...
TEST (block_builder, state_errors)
{
	...
	builder.state ().account_hex ("brl_bad").build (ec);
	ASSERT_EQ (ec, nano::error_common::bad_account_number);

	builder.state ().zero ().account_address ("brl_1111111111111111111111111111111111111111111111111111hifc8npp").build (ec);
	ASSERT_NO_ERROR (ec);
}
...
TEST (block_builder, open)
{
	...
	auto block = builder
				 .open ()
				 .account_address ("brl_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3")
				 .representative_address ("brl_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3")
...
TEST (block_builder, change)
{
	...
	auto block = builder
				 .change ()
				 .representative_address ("brl_3rropjiqfxpmrrkooej4qtmm1pueu36f9ghinpho4esfdor8785a455d16nf")
...
TEST (block_builder, send)
{
	...
	auto block = builder
				 .send ()
				 .destination_address ("brl_1gys8r4crpxhp94n4uho5cshaho81na6454qni5gu9n53gksoyy1wcd4udyb")
	...
	ASSERT_FALSE (block->source_field ());
	ASSERT_EQ (block->destination_field ().value ().to_account (), "xbrl_1gys8r4crpxhp94n4uho5cshaho81na6454qni5gu9n53gksoyy1wcd4udyb");
	ASSERT_FALSE (block->link_field ());
}
