...
TEST (rpc, accounts_balances)
{
	...
	auto const account_not_found = "xbrl_1os6txqxyuesnxrtshnfb5or1hesc1647wpk9rsr84pmki6eairwha79hk3j";
...
TEST (rpc, accounts_balances_with_errors)
{
	...
	boost::property_tree::ptree entry;
	auto const bad_account_number = "xbrl_3e3j5tkog48pnny9dmfzj1r16pg8t1e76dz5tmac6iq689wyjfpiij4txtd1";
...
TEST (rpc, accounts_representatives_with_errors)
{
	...
	auto const bad_account_number = "xbrl_36uccgpjzhjsdbj44wm1y5hyz8gefx3wjpp1jircxt84nopxkxti5bzq1rnz";
	entry2.put ("", bad_account_number);
	accounts_l.push_back (std::make_pair ("", entry2));

	// Adds a valid key but that isn't on the ledger. It won't be found.
	auto const account_not_found = "xbrl_1hrts7hcoozxccnffoq9hqhngnn9jz783usapejm57ejtqcyz9dpso1bibuy";
