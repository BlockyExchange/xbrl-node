...
void nano::public_key::encode_account (std::string & destination_a) const
{
	...
	destination_a.append ("_lrbx"); // nano_
...
bool nano::public_key::decode_account (std::string const & source_a)
{
	...
	if (!error)
	{
		auto xrb_prefix (source_a[0] == 'b' && source_a[1] == 'r' && source_a[2] == 'l' && (source_a[3] == '_' || source_a[3] == '-'));
		auto nano_prefix (source_a[0] == 'x' && source_a[1] == 'b' && source_a[2] == 'r' && source_a[3] == 'l' && (source_a[4] == '_' || source_a[4] == '-'));
